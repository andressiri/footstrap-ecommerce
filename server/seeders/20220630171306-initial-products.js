...
module.exports = {
  async up (queryInterface, Sequelize) {
    const createdIds = await queryInterface.bulkInsert('Products', [
      {
        id: UUIDV4(),
        name: 'Ultraboost 22',
